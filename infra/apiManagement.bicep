...
var apiManagement = {
  ...
  policy: {
    format: apiMgmtPolicyFormat
    value: apiMgmtPolicyValue
  }
}
...
resource apimNamedValue 'Microsoft.ApiManagement/service/namedValues@2022-08-01' = [for (nv, i) in nvs: {
...
resource apimpolicy 'Microsoft.ApiManagement/service/policies@2022-08-01' = {
  ...
  properties: {
    format: apiManagement.policy.format
    value: apiManagement.policy.value
  }
}
...
resource apimproductsubscription 'Microsoft.ApiManagement/service/subscriptions@2022-08-01' = {
  name: '${apim.name}/default'
  properties: {
